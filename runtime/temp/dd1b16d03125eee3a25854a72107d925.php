<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:26:"../public/index_admin.html";i:1466554893;}*/ ?>
<!DOCTYPE html>
...
<body class="page-body" ng-controller="MainCtrl" ng-class="{'settings-pane-open': layoutOptions.settingsPane.isOpen, 'chat-open': layoutOptions.chat.isOpen, 'login-page': isLoginPage && isMainPage == false, 'login-light': isLightLoginPage && isMainPage == false, 'lockscreen-page': isLockscreenPage && isMainPage == false, 'right-sidebar': layoutOptions.sidebar.isRight, 'boxed-container': layoutOptions.container.isBoxed}">
	...
	<!-- Bottom Scripts -->
	<script src="/app_admin/js/angular/angular.min.js"></script>
	<script src="/app_admin/js/angular-ui/angular-ui-router.min.js"></script>
	<script src="/app_admin/js/angular-ui/ui-bootstrap-tpls-0.11.2.min.js"></script>
	<script src="/app_admin/js/angular/angular-cookies.min.js"></script>
	<script src="/app_admin/js/oc-lazyload/ocLazyLoad.min.js"></script>
	<script src="/app_admin/js/angular-fullscreen.js"></script>
	...
	<!-- App -->
	<script src="/app_admin/js/app.js"></script>
	<script src="/app_admin/js/controllers.js"></script>
	<script src="/app_admin/js/directives.js"></script>
	<script src="/app_admin/js/factory.js"></script>
	<script src="/app_admin/js/services.js"></script>


	<!-- JavaScripts initializations and stuff -->
	<script src="/app_admin/js/xenon-custom.js"></script>
